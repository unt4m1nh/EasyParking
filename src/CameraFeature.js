    ...
    return (
        <View style={styles.background}>
            ...
            <View style={styles.resultContainer}>
                <Text style={styles.textLight}> Khoảng cách giũa 2 xe phía trước</Text>
                <Text style={{
                    ...styles.textAlert,
                    color: serverMessage > vehicleWidth ? 'green' : 'red'
                }}>{serverMessage ?? 'Objects not found'}</Text>
                {
                    serverMessage !== null ? <Text style={{
                        ...styles.textAlert,
                        color: serverMessage > vehicleWidth ? 'green' : 'red'
                    }}>{serverMessage > vehicleWidth ? 'Vừa' : 'Không vừa'}</Text> : ''
                }
            </View>
        </View>
    )
