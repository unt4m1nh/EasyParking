...
function MapScreen({navigation}) {
    ...
    fetch(url, requestOptions)
      ...
      .then(result => {
        ...
        const arrayOfCoordinates =
          result.features[0].geometry.coordinates[0].map(arr => {
            return {
              latitude: arr[1],
              longitude: arr[0],
            };
  ...
  const getLocation = () => {
    //21.03836149564546, 105.78269432430432
    setShowSpinner(true);
    Geolocation.getCurrentPosition(
      ...
      error => {
        ...
        setCurrentLatitude(21.03836149564546);
        setCurrentLongtitude(105.78269432430432);
    ...
    <View style={{marginTop: 0, flex: 1}}>
      <MapView
        ...
        <Marker
          ...
          image={require('./img/my-location.png')}></Marker>
        <Circle
        ...
        {showMarker && (
          <Marker
            ...
            image={require('./img/location.png')}></Marker>
        )}
            ...
            <ScrollView>
              {predictions.map((item, index) => (
                <TouchableOpacity
                  ...
                  <Text style={styles.textDarkRegular} key={index}>
                    {item.name}
                  </Text>
                </TouchableOpacity>
              ))}
      ...
      {show && (
        <View style={styles.marker_callout}>
          ...
          <Image
            source={{
              uri: 'https://upload.wikimedia.org/wikipedia/commons/6/6d/Tel_Aviv_parking_lot.jpg',
            }}
            resizeMode="cover"
            style={styles.parkingImage}
          />
          <DynamicText text={pData.nameParking} />
        ...
        <View style={styles.bookingDetails}>
          <View style={styles.bookingDetails}>
            <View
              ...
              <Text style={{...styles.textPurple, color: '#212121'}}>
                Thông tin đặt chỗ
              </Text>
            </View>
            <Text
              style={{...styles.textPurple, fontSize: 20, color: '#212121'}}>
              Lựa chọn ngày
            </Text>
            <View style={styles.dateTime}>
              ...
              <TouchableOpacity
                ...
                <Text style={{color: '#212121', alignSelf: 'flex-end'}}>
                  Chọn
                </Text>
              </TouchableOpacity>
            </View>
            ...
            <Text
              style={{...styles.textPurple, fontSize: 16, color: '#212121'}}>
              Tổng tiền
            </Text>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  mapViewRef.current?.fitToCoordinates(
                    [
                      {latitude: currentLatitude, longitude: currentLongtitude},
                ...
                <Text style={{color: '#4448AE', fontWeight: 'bold'}}>
                  Đặt ngay
                </Text>
              </TouchableOpacity>
              <LinearGradient
        ...
        <View style={styles.navigationContainer}>
          ...
          <View
            ...
            <Text style={styles.textDarkRegular}>
              {instructionsArray[currentIndex]}
            </Text>
          </View>
          <View style={{display: 'flex', flexDirection: 'row'}}>
            <TouchableOpacity
              ...
              <Text style={{...styles.textDark, color: '#4448AE'}}>
                Trở lại
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
